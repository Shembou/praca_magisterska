...
\textbf{WebAssembly} (Wasm) jest binarnym formatem wykonywalnym, pozwalającym uruchamiać kod napisany w Rust bezpośrednio w przeglądarce. W projekcie zostało wykorzystane do:
\begin{itemize}[itemsep=0.2em, parsep=0pt, topsep=0pt]
