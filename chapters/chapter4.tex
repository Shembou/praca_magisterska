...
Rysunek~\ref{fig:file_structure}, na str.~\pageref{fig:file_structure}, przedstawia architekturę przygotowanego środowiska testowego. Projekt składa się z pięciu głównych katalogów, z których każdy odpowiada za odrębny aspekt przeprowadzanych badań.
...
Katalog wasm-showcase zawiera kompletną aplikację webową demonstrującą możliwości technologii \texttt{WebAssembly}. Struktura projektu obejmuje następujące elementy:
\begin{itemize}
