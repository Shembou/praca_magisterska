...
Bun jest nowoczesnym środowiskiem uruchomieniowym dla języka JavaScript, TypeScript oraz WebAssembly, pełniącym jednocześnie rolę menedżera pakietów, narzędzia do budowania aplikacji oraz serwera uruchomieniowego \cite{bun}. Jego głównym celem jest zwiększenie wydajności i uproszczenie procesu tworzenia aplikacji webowych poprzez integrację funkcjonalności, które w tradycyjnym ekosystemie Node.js realizowane są przez wiele odrębnych narzędzi.
